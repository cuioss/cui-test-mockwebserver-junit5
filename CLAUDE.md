...
5. Enable auto-merge: `gh pr merge --repo cuioss/cui-test-mockwebserver-junit5 --auto --squash --delete-branch`
6. Wait for merge (check every ~60s): `while gh pr view --repo cuioss/cui-test-mockwebserver-junit5 --json state -q '.state' | grep -q OPEN; do sleep 60; done`
